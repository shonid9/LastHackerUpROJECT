...
function Users() {
  ...
  useEffect(()=>{
    ...
    axios.get("https://localhost:3306/auth", head).then((res)=>{
        setUserList(res.data);
    });

    axios.get("https://localhost:/auth/approve", head).then((res)=>{
  ...
  const handleApprove =()=>{
    ...
    if (approvedList.length!==0) {
      ...
      axios.put("https://localhost:3306/auth/approve", approvedList, head).then((res)=>{
