...
function CreateItem() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://localhost:3306/categories/${selectedCategory.id}`).then((rescateg)=>{
    ...
    const handleCloseDialog = () => {
        ...
        axios.post("https://localhost:3306/items", holdData, head).then((res)=>{
    ...
    return (
        <div style={{minHeight: '100vh', width: '100%',
                     backgroundImage: `url("https://localhost:3306/images/background.png")`,
