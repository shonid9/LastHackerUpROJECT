...
function Item() {
    ...
    const [holdBidData, setHoldBidData ] = useState({});
     ...
     const bidOnIt = () =>{
        ...
        axios.post(`https://localhost:3306/bids/`, holdBidData, head).then((res)=>{
        });
        ...
        axios.post(`https://localhost:3306/history/bid/${itemObject.id}`, body2, head).then((reshi)=>{
        });
    ...
    const buyIt = () =>{
        ...
        if (Math.floor((Date.parse(itemObject.ends)-Date.parse(today)))<=0){
            ...
            axios.put(`https://localhost:3306/items/purchase/${itemObject.id}`, body, head).then((res)=>{
            });
    ...
    const deleteItem = () =>{
        ...
        axios.delete(`https://localhost:3306/items/${itemObject.id}`, head).then((res)=>{
        });
        navigate(`/`);
    };
    ...
    const editItem = (attribute) =>{
     ...
     const switchCategory = () =>{
         ...
         if ((Object.keys(selectedCategory).length > 0 )){
            ...
            axios.put(`https://localhost:3306/items/category/${itemObject.id}`, body, head).then((res)=>{
            });
        ...
        if (locationValue){
            ...
            if ( locationValue === itemObject.location ){
                ...
                if (locationValue!=null){
                    ...
                    axios.put(`https://localhost:3306/items/location/${itemObject.id}`, body, head).then((res)=>{
                    });
    ...
    const switchCoordinates = () =>{
        ...
        if (Object.keys(coordinatesValue).length > 0 ){
            ...
            axios.put(`https://localhost:3306/items/coordinates/${itemObject.id}`, body, head).then((res)=>{
            });
     ...
     const switchName = () =>{
        ...
        if (nameValue){
            ...
            axios.put(`https://localhost:3306/items/name/${itemObject.id}`, body, head).then((res)=>{
            });
     ...
     const switchDescription = () =>{
         ...
         if (descriptionValue){
            ...
            axios.put(`https://localhost:3306/items/description/${itemObject.id}`, body, head).then((res)=>{
            });
    ...
    const switchCountry = () =>{
        if (countryValue){
            ...
            axios.put(`https://localhost:3306/items/country/${itemObject.id}`, body, head).then((res)=>{
            });
        ...
        if (startedValue){
            ...
            if ( Date.parse(startedValue)-Date.parse(new Date()) <= 0 ){
                ...
                if (startedValue!=null){
                    ...
                    axios.put(`https://localhost:3306/items/started/${itemObject.id}`, body, head).then((res)=>{
                    });
        ...
        if (endsValue){
            ...
            if ( Date.parse(endsValue)-Date.parse(new Date()) <= 0 ){
                ...
                if (endsValue!=null){
                    ...
                    // console.log(body);
                    axios.put(`https://localhost:3306/items/ends/${itemObject.id}`, body, head).then((res)=>{
                    });
      ...
      const switchBuyPrice = () =>{
          ...
          if (buyPriceValue){
              ...
              if ( buyPriceValue <= itemObject.currently ){
                ...
                // console.log(body);
                axios.put(`https://localhost:3306/items/buyprice/${itemObject.id}`, body, head).then((res)=>{
                });
          ...
          if (currentlyValue){
              ...
              if ( currentlyValue >= itemObject.buy_price ){
                  ...
                  if (currentlyValue!=null){
                      ...
                      // console.log(body);
                      axios.put(`https://localhost:3306/items/currently/${itemObject.id}`, body, head).then((res)=>{
                      });
    ...
    useEffect(()=>{
        ...
        axios.get(`https://localhost:3306/items/fetchy/${id}`).then((res)=>{
            ...
            axios.get(`https://localhost:3306/photos/${id}`).then((resimag)=>{
                setImages(resimag.data);
            });

            // Then get the categories recursively and return them from parent to children
            axios.get(`https://localhost:3306/categories/${res.data.furthermostCategoryId}`).then((rescateg)=>{
                setCategories(rescateg.data);
            });
            
            // Then get the seller information required
            if (res.data.UserId){
                axios.get(`https://localhost:3306/auth/fetchy/${res.data.UserId}`).then((respo)=>{
            ...
            if (res.data.UserId===authState.id){
                ...
                axios.get(`https://localhost:3306/bids/${id}`).then((response)=>{
                ...
                if (authState && authState.username!== "admin"){
                    ...
                    axios.post(`https://localhost:3306/history/click/${id}`, body, head).then((respirespi)=>{
                    });
