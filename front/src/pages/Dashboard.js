...
function Dashboard() {
    ...
    useEffect(()=>{
            ...
            axios.get(`https://localhost:3306/auth/fetchyall/${id}`).then((response)=>{
                if(response.data.message){
                    ...
                    axios.get(`https://localhost:3306/mail/newmail/${id}`).then((respi)=>{
                    ...
                    axios.get(`https://localhost:3306/items/fetchByUser/${id}`).then((res)=>{
                    ...
                    axios.get(`https://localhost:3306/items/mywatchlist/${id}`).then((resbidy)=>{
